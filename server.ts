...
let providers: Provider[] = [
  {
    id: 1,
    user_id: 2,
    business_name: "CoolAir Solutions & HVAC",
    categories: "AC Service, Inverter Maintenance, HVAC",
    experience_years: 12,
    location: "Mumbai",
    base_price: "₹500 - ₹2000",
    description: "Certified inverter AC servicing, coil chemical wash, compressor health checks, and duct cleaning across Mumbai MMR.",
  ...
  },
  {
    id: 2,
    user_id: 3,
    business_name: "Sparky Electricals & Energy Audit",
    categories: "Electrical Maintenance, Wiring, Energy Audit",
    experience_years: 8,
    location: "Delhi",
    base_price: "₹400 - ₹1800",
    description: "Residential 230V rewiring, smart energy meter integration, MCB & ELCB earth-leakage testing, and BEE audit in Delhi NCR.",
    availability_status: "Available",
    rating: 4.9,
    verified: true,
  },
  {
    id: 3,
    user_id: 4,
    business_name: "SolarEdge Rooftop Systems",
    categories: "Solar Installation, Net Metering, PM Surya Ghar",
    experience_years: 15,
    location: "Pune",
    base_price: "Free Assessment • Custom Quote",
    description: "MNRE-empanelled rooftop solar PV installation, MSEDCL net-metering liaison, and PM Surya Ghar subsidy processing.",
    availability_status: "Available",
    rating: 4.7,
    verified: true,
  },
  {
    id: 4,
    user_id: 2,
    business_name: "Bangalore Green Energy Tech",
    categories: "Solar Installation, Smart Meters, Battery Storage",
    experience_years: 10,
    location: "Bengaluru",
    base_price: "₹600 - ₹2500",
    description: "BESCOM-approved net metering partner, rooftop solar EPC, BLDC motor upgrades, and lithium battery inverter backup systems.",
    availability_status: "Available",
    rating: 4.9,
    verified: true,
  },
  {
    id: 5,
    user_id: 3,
    business_name: "Deccan Electricals & Power Care",
    categories: "Wiring, AC Service, Home Energy Audit",
    experience_years: 9,
    location: "Hyderabad",
    base_price: "₹350 - ₹1600",
    description: "TSSPDCL residential compliance, 3-phase load balancing, heavy appliance dedicated cabling, and inverter AC optimization in Hyderabad & Secunderabad.",
    availability_status: "Available",
    rating: 4.8,
    verified: true,
  },
  {
    id: 6,
    user_id: 4,
    business_name: "Chennai Solar & Energy Dynamics",
    categories: "Solar Installation, Net Metering, Inverter Maintenance",
    experience_years: 14,
    location: "Chennai",
    base_price: "Free Solar Audit • ₹500+",
    description: "TANGEDCO solar grid-tie installer, PM Surya Ghar subsidy paperwork support, anti-corrosive coastal PV mounts, and inverter servicing.",
    availability_status: "Available",
    rating: 4.8,
    verified: true,
  },
  {
    id: 7,
    user_id: 2,
    business_name: "Bengal Power & Cooling Masters",
    categories: "AC Service, Electrical Maintenance, Wiring",
    experience_years: 11,
    location: "Kolkata",
    base_price: "₹400 - ₹1500",
    description: "WBSEDCL & CESC licensed wiring contractor, split AC deep cleaning, voltage stabilizer installation, and power surge arresters.",
    availability_status: "Available",
    rating: 4.7,
    verified: true,
  },
  {
    id: 8,
    user_id: 3,
    business_name: "Gujarat Surya Urja Solutions",
    categories: "Solar Installation, PM Surya Ghar, Net Metering",
    experience_years: 13,
    location: "Ahmedabad",
    base_price: "₹500 - ₹2200",
    description: "GUVNL & Torrent Power empanelled rooftop solar vendor. Highest subsidy claim success rate under Surya Gujarat / PM Surya Ghar.",
    availability_status: "Available",
    rating: 4.9,
    verified: true,
  },
  {
    id: 9,
    user_id: 4,
    business_name: "Pink City Energy & Solar Works",
    categories: "Solar Installation, Electrical Maintenance, Inverter Services",
    experience_years: 7,
    location: "Jaipur",
    base_price: "₹450 - ₹1800",
    description: "JVVNL grid synchronization, high-efficiency monocrystalline solar panels, tubular battery maintenance, and desert heat AC tune-ups.",
    availability_status: "Available",
    rating: 4.8,
    verified: true,
  },
  {
    id: 10,
    user_id: 2,
    business_name: "Awadh Power & HVAC Services",
    categories: "AC Service, Wiring, Home Energy Audit",
    experience_years: 8,
    location: "Lucknow",
    base_price: "₹350 - ₹1400",
    description: "UPPCL residential load enhancement, copper pipe AC leak repairs, earthing pit installation, and smart power monitor fitting.",
    availability_status: "Available",
    rating: 4.7,
    verified: true,
  },
  {
    id: 11,
    user_id: 3,
    business_name: "Kerala Eco Power & Solars",
    categories: "Solar Installation, Inverter Maintenance, Energy Audit",
    experience_years: 12,
    location: "Kochi",
    base_price: "₹500 - ₹2000",
    description: "KSEB Soura scheme installer, lightning protection, monsoon-ready waterproof solar mounting, and BLDC fan conversions.",
    availability_status: "Available",
    rating: 4.9,
    verified: true,
  },
  {
    id: 12,
    user_id: 4,
    business_name: "North Star Electricals & Solar",
    categories: "Electrical Maintenance, Solar Installation, Wiring",
    experience_years: 10,
    location: "Chandigarh",
    base_price: "₹400 - ₹1700",
    description: "Serving Chandigarh Tricity (Mohali, Panchkula). PSPCL/DHBVN solar net-metering, heat pump geyser setups, and power factor correction.",
    availability_status: "Available",
    rating: 4.8,
    verified: true,
  },
...
app.get("/api/service-requests/user/:user_id", (req: Request, res: Response) => {
  ...
  const list = serviceRequests
    ...
    .map((r) => {
      const p = providers.find((prov) => prov.id === r.provider_id);
      return {
        ...r,
        provider_name: p ? p.business_name : "Certified Energy Specialist",
        provider_location: p ? p.location : "India",
        provider_categories: p ? p.categories : "Electrical",
      };
    });
  res.json(list);
});
